...
(
    "Venta_idventa" integer NOT NULL DEFAULT nextval('"Calificacion_Venta_idventa_seq"'::regclass),
...
(
    "Venta_idventa" integer NOT NULL DEFAULT nextval('"Detalle_Venta_Venta_idventa_seq"'::regclass),
